...
"""
Programmers often comment out and uncomment code as they work. 
But there's a much more important use for comments. When you write code, you should also document it. 
Documentation helps you record why you made certain decisions and explain how your code works. 
You could write such explanatory material in a separate file, but it's much easier to be able to read the documentation of your code inline with the code itself. 
