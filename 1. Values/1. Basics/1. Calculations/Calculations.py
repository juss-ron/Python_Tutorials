# Calculations
#
# You can use a playground like a calculator.
# Type in the math problem you want solved and the results sidebar shows the answer, or the result, of the calculation.
#
...
# (If the two numbers don't divide evenly, the remainder is discarded.)
#
...
#
# Note that Python observes the standard precedence of operations: * and / before + and -.
#
