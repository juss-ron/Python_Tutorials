# Exercise: 3
    ...
    # In this exercise, you'll figure out the answer to the timeless question: How much stuff can I fit on my Phone?

    # Unlike the previous exercises, no code will be provided. But here are a few things you’ll need to know:

        # Phone storage capacity is measured in gigabytes (GB).
...
#Enter your code under this👇 and print the result
