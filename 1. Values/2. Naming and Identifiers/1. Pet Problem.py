...
# Now imagine that all you have with you is a laptop with Xcode on it. 
# Maybe you can use a playground to help your friend.
...
#
# Then you could copy those numbers onto new lines of code and let python do some math for you, like this:
#
...
# Experiment
# As the week goes on, you get more information about what pets will be in the show.
