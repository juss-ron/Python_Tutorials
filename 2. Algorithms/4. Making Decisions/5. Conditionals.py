...
#
    ...
    # In the code above, you can see in the results sidebar that the first if statement is run. 
    # The code inside the second if statement isn’t executed because the conditions for it aren’t true.

# Experiment
    # Change the value of video_length and see how the new value affects the code that is run.

# Experiment
    # What happens if you change the comparison in the first example, so it complains about videos shorter than 10 seconds? 
    # What happens if you then set the videoLength to 8?
